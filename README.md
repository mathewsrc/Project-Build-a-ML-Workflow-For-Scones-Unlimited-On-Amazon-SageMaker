Building a Machine Learning Workflow for Scones Unlimited on Amazon SageMaker

This project leverages AWS Sagemaker to develop an image classification model capable of distinguishing between bicycles and motorcycles . Lambda functions were used too to build supporting services and AWS Step Functions to compose the model and services into an event-driven application.
